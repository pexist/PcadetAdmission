"""
Django settings for PcadetAdmission project.
...
SECRET_KEY = 'qre!xd5-(iu2+)xet!g+_w(=p79n#18ydu3l##o76^jj$5xe+@'
...
ROOT_URLCONF = 'PcadetAdmission.urls'
...
WSGI_APPLICATION = 'PcadetAdmission.wsgi.application'
