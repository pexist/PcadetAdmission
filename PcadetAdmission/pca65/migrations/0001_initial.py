# Generated by Django 3.2.4 on 2021-06-07 04:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ID13', models.CharField(help_text='หมายเลขบัตรประจำตัวประชาชน', max_length=13, null=True)),
                ('Stat', models.CharField(max_length=2)),
                ('DIN', models.CharField(max_length=10, null=True)),
                ('Piccomment', models.CharField(max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('AID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pca65.id13in')),
            ],
        ),
    ]
